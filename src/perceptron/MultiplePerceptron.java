...
// currentIndex = i;
// Utilities.outputArray("initial weights:", this.weights.get(currentIndex),
// true);
// int epochs = 0;
//
...
// double[] temp = epoch(features, labelsArray.get(this.currentIndex),
// LEARNING_RATE,
...
// ++epochs;
// double accuracy = measureAccuracy(features,
// this.labelsArray.get(this.currentIndex), null);
//
