...
public class MLSystemManager {
	...
	public void run(String[] args) throws Exception {
		...
		String learnerName = parser.getLearner(); // Learning algorithm
													// specified by the user
		String evalMethod = parser.getEvaluation(); // Evaluation method
													// specified by the user
		String evalParameter = parser.getEvalParameter(); // Evaluation
															// parameters
															// specified by the
															// user
				...
				for (int i = 0; i < argv.length; i++) {
					...
					if (argv[i].equals("-V")) {
						...
						if (argv[i].equals("static")) {
							...
							// expecting a double representing the percentage
							// for testing
